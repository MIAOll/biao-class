...
function preparePlaceholder() {
    ...
    var desc = document.createTextNode("鞠婧祎");
    // description.appendChild(desc);

    placeholder.setAttribute("src", "image/slide.jpg");
    placeholder.setAttribute("id", "placeholder");
    placeholder.setAttribute("class", "picCenter");
    // addClass(placeholder, "picCenter");
